<template>
  <div>
    ...
    <div class="app-body">
      <div class="sidebar" v-show="auth">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon fas fa-mosque"></i> Planeación
              </a>
              <ul class="nav-dropdown-items">
                <!-- <li class="nav-item"> -->
                <li class="nav-item">
                  <router-link tag="a" to="/gateway/create-planning" class="nav-link">
                    <i class="nav-icon far fa-edit"></i> Crear
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link tag="a" to="/gateway/edit-planning" class="nav-link">
                    <i class="nav-icon far fa-plus-square"></i> Editar
                  </router-link>
                </li>
              </ul>
            </li>
      ...
      <aside class="aside-menu" v-show="auth">
